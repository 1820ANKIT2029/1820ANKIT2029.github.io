                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {projects.length === 0 ? (
                        ...
                        projects.map((project) => (
                            <div key={project.id} className="bg-base-200 rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300">
                                <h3 className="text-xl font-semibold mb-2">{project.name}</h3>
                                <p className="mb-4 line-clamp-3">{project.description || "No description provided."}</p> {/* Handles missing descriptions */}
